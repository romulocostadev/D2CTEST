...
export const ProductCardHorizontal = styled(Layout)`
  min-width: 100vw;
  min-height: 100vh;
...
export const ProductImage = styled(Col).attrs({ md: 2, xs: 24 })``;

export const PhotoCarouselSquare = styled(Row).attrs({
  align: 'middle',
  justify: 'center',
})`
  background-color: #ffffff;
...
export const MainInfo = styled(Col).attrs({ md: 6, xs: 24 })``;
...
export const MainInfoSpacing = styled(Space).attrs({
  ...
  width: 100%;
`;
export const ProductNameWrapper = styled(Row).attrs({
  justify: 'start',
})``;
...
export const ProductOfferType = styled(Col).attrs({ md: 4, xs: 24 })`
...
export const InfoRightSpacing = styled(Space).attrs({
  ...
  width: 100%;
`;
export const PriceOptionsWrapper = styled(Row).attrs({
  justify: 'start',
})``;
...
export const MinimumPurchaseWrapper = styled(Col).attrs({ md: 11, xs: 24 })``;
...
export const AvailableQuantity = styled(Col).attrs({ md: 11, xs: 24 })``;
