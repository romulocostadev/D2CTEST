...
export const PriceInfo = styled(Col).attrs({ md: 7, xs: 24 })``;
...
export const ProducedBy = styled(Col).attrs({ md: 10, xs: 24 })``;
...
export const QualityInfo = styled(Col).attrs({ md: 15, xs: 24 })``;
